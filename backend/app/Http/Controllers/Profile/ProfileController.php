...
class ProfileController extends Controller{
 ...
 public function notifications(Request $r){return $r->user()->notification_settings??['emailAlerts'=>true,'deviceAlerts'=>true,'weeklyReports'=>false,'billingAlerts'=>true];}
 public function updateNotifications(Request $r){$d=$r->validate(['emailAlerts'=>'required|boolean','deviceAlerts'=>'required|boolean','weeklyReports'=>'required|boolean','billingAlerts'=>'required|boolean']);$r->user()->update(['notification_settings'=>$d]);return $d;}
}
