...
export const typography={display:"2rem",heading:"1.5rem",sectionHeading:"1rem",body:"0.875rem",small:"0.8125rem",caption:"0.75rem",label:"0.75rem"} as const;
export const motion={fast:"120ms",normal:"180ms",slow:"240ms",ease:"cubic-bezier(0.2, 0, 0, 1)"} as const;
export const iconSizes={small:14,default:16,medium:18,large:20} as const;
